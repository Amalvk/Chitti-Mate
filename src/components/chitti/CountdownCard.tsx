...
export function CountdownCard({ targetIso, label = 'Next auction' }: CountdownCardProps) {
  ...
  return (
    <div className="rounded-3xl border border-brand-100 bg-brand-50/60 p-5 text-center sm:p-6 dark:border-brand-500/25 dark:bg-brand-500/10">
      <div className="mb-3 flex items-center justify-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400">
